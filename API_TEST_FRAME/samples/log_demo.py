...
log_path = os.path.join(os.getcwd(),  '..', 'logs', daytime + 'test_log.txt')       # 拼接路径和文件名，将日志打印只logs目录下面
# print(log_path)
...
logging.debug('这是一个debug日志信息')
logging.info('这是一个info日志信息')
logging.warning('这是一个warning日志信息')
logging.error('这是一个error日志信息')
